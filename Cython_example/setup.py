...
if platform.system().lower() == "linux":
    ...
    shutil.copy("build/Release/student.dll", "src/student/lib/student.dll")
    shutil.copy("build/Release/student.lib", "src/student/lib/student.lib")
    cstudent = Extension('Pystudent', 
                    ['src/student/student_module.pyx'],  
                    include_dirs=["src/student/include", np.get_include()],               
                    library_dirs=["src/student/lib"],
    ...
    # 注意，在 import Pystudent 之前需要 apppend 动态库 lib 的路径
else:
    raise KeyError("Unsupport platform: {}".format(platform.system.lower()))
